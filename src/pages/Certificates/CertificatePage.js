...
import CertificateCard from "../../components/Certificates/CertificateCard.js";

function CertificatePage() {
  const [search, setSearch] = useState("");
  const { theme } = useContext(ThemeContext);

  const filteredArticles = certificatesData.certificates.filter(
    (certificate) => {
      const content = certificate.title + certificate.details;
